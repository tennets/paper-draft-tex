...
\section{Discussion \label{sec:discussion}}
	...
	However, here (see \refapp{sec:ffsp}), we focus on and use a basic version of such software called \href{https://github.com/tennets/paper-draft-tex/blob/main/matlab/ffsp.m}{\texttt{ffsp}}. 